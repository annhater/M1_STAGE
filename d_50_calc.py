...
plt.show()
#save plot
fig.savefig("/home/sdv/m1isdd/aperova/Documents/M1_STAGE/Manips/Figures/d_50_all_simulations.png", bbox_inches='tight', dpi=300)
...
# Write csv
summary_stats_df.to_csv('/home/sdv/m1isdd/aperova/Documents/M1_STAGE/Manips/d_50_stats.csv', index=True, header=True, decimal=".", float_format="%.3f")
