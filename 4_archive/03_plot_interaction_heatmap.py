...
freq_df_paths = ["V1_ASP_chB_env_atoms_frequency.csv",
                ...
                "V8_ASP_chB_env_atoms_frequency.csv",
                "V21_ASP_chB_env_atoms_frequency.csv"]
