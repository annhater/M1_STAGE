...
# RMSD is a measurement of the protein structure deviation with respect to the initial structure
...
# FUNCTIONS
# a. RMSD with MDAnalysis
def get_rmsd(gro, xtc):
...
axes = axes.flatten()
fig.suptitle("RMSD Comparison: Condition 1 vs Condition 2 Simulations", fontsize=22, y=0.92)
plot_idx = 0
line_c1 = None
line_c2 = None
...
plt.show()
fig.savefig("/home/sdv/m1isdd/aperova/Documents/M1_STAGE/Manips/Figures/rmsd_all_simulations1.png", bbox_inches='tight', dpi=300)
